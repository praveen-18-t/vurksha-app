...
/// A class that contains all theme configurations for the organic farm-to-home delivery application.
/// Implements Contemporary Organic Minimalism with Fresh Earth Palette.
class AppTheme {
  AppTheme._();

  // Fresh Earth Palette - Primary Colors
  static const Color primaryLight = Color(0xFF2E7D32); // Deep organic green
  ...
  static const Color secondaryVariantLight = Color(
    0xFF33691E,
  ); // Darker supporting green

  // Surface and Background Colors
  static const Color backgroundLight = Color(
    0xFFFFFFFF,
  ); // Pure white for product clarity
  static const Color surfaceLight = Color(
    0xFFFAFAFA,
  ); // Clean background for product photography
  ...
  static const Color accentLight = Color(
    0xFFFF6F00,
  ); // Warm orange for urgent actions
  static const Color successLight = Color(0xFF4CAF50); // Confirmation states
  static const Color warningLight = Color(0xFFFFC107); // Stock alerts
  ...
  // Dark Mode Accent and Status Colors
  ...
  // Divider colors - Functional space definition
  static const Color dividerLight = Color(0xFFE0E0E0);
  static const Color dividerDark = Color(0xFF424242);

  // Text colors with proper emphasis levels
  static const Color textHighEmphasisLight = Color(0xDE1C1C1E); // 87% opacity
  static const Color textMediumEmphasisLight = Color(0x991C1C1E); // 60% opacity
  static const Color textDisabledLight = Color(0x611C1C1E); // 38% opacity
  ...
  /// Light theme with Contemporary Organic Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // Button themes with solid colors
    ...
    // Input decoration with functional borders
  ...
  /// Dark theme with Contemporary Organic Minimalism
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Body styles - Optimized for product descriptions
